...
**Время генерации:** 2025-08-11 09:56:08

## 1. Сводная статистика

| Метрика | Значение |
|:---|:---|
| Общая точность (Accuracy) | 46.85% |
| Средняя уверенность (Score) | 0.7833 |
| P50 Latency (ms) | 43.52 |
| P95 Latency (ms) | 59.86 |
